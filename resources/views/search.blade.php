...
@section('content')
    ...
    <div id="page-title" class="padding-tb-30px gradient-white">
        <div class="container text-left">
            ...
            <h1 class="font-weight-300">Recipes - results</h1>
        </div>
    </div>
            ...
            <div class="col-lg-6 margin-bottom-30px">
                <div class="background-white thum-hover box-shadow hvr-float full-width">
                    <div class="float-md-left margin-right-30px thum-xs">
                        ...
                        <img class="width-250px" style="height: 200px;" src="/assets/img/{{$recipe->img}}" alt="">
                    </div>
                    <div class="padding-25px">
                        ...
                        <div class="row no-gutters">
                            ...
                            <a href="{{url('/user/profile',['id'=>$recipe->user_id])}}" class="d-inline-block text-grey-3 h6 margin-bottom-0px margin-right-15px"><img src="/assets/img/{{App\User::find($recipe->user_id)->img}}" class="height-30px border-radius-30 margin-right-10px" alt=""> {{App\User::find($recipe->user_id)->name}}</a>
                        </div>
                        </div>
                    </div>
